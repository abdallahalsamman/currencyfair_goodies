...
class TransactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get yearly_report" do
    get transactions_yearly_report_path
    assert_response :success
  end

  test "should accept transaction" do
    post api_process_transaction_path, params: {userId: "134256", currencyFrom: "EUR", currencyTo: "GBP", "amountSell": 1000,
  ...
  test "should reject transaction with same currencyFrom and currencyTo" do
    ...
    post api_process_transaction_path, params: {userId: "134256", currencyFrom: "GBP", currencyTo: "GBP", "amountSell": 1000,
                   amountBuy: 747.10, rate: 0.7471, timePlaced: "24-JAN-15 10:27:44", originatingCountry: "FR"}
    assert_response :bad_request
  end

  test "should reject transaction with amountSell or amountBuy as a string" do
    post api_process_transaction_path, params: {userId: "134256", currencyFrom: "GBP", currencyTo: "EUR", "amountSell": 'wrong_type',
                   amountBuy: 747.10, rate: 0.7471, timePlaced: "24-JAN-15 10:27:44", originatingCountry: "FR"}
    assert_response :bad_request

    post api_process_transaction_path, params: {userId: "134256", currencyFrom: "GBP", currencyTo: "EUR", "amountSell": 123.1,
  ...
  test "should reject transaction with currencyFrom or currencyTo as invalid currency name" do
    post api_process_transaction_path, params: {userId: "134256", currencyFrom: "GBPA", currencyTo: "EUR", "amountSell": 1000,
                   amountBuy: 747.10, rate: 0.7471, timePlaced: "24-JAN-15 10:27:44", originatingCountry: "FR"}
    assert_response :bad_request

    post api_process_transaction_path, params: {userId: "134256", currencyFrom: "EUR", currencyTo: "GBPP", "amountSell": 1000,
                   amountBuy: 747.10, rate: 0.7471, timePlaced: "24-JAN-15 10:27:44", originatingCountry: "FR"}
    assert_response :bad_request
  end
